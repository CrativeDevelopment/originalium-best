...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: HbCp-tzDHuqlMm/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: LDjGHulu5QErqB/icon
import Icon38Icon from "./icons/PlasmicIcon__Icon38"; // plasmic-import: vRpDDGIYtxfx7-/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__ogUxd)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg___9VUco)}
                role={"img"}
              />
            ),
